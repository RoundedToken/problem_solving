...
export function marquee(input: string, displayAmount = input.length, options: {convertToUpperCase?: boolean, unknownChar?: 'exception'}) {
    const frames = [];
...
export function blink(input: string, counts = 10, options: {convertToUpperCase?: boolean, unknownChar?: 'exception'}) {
    const frames = [];
...
export function typing(input: string, options: {convertToUpperCase?: boolean, unknownChar?: 'exception'}) {
    const frames = [];
    const text = stringToDisplay(input, options);
